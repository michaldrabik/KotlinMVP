...
public class MainActivityTest {
  ...
  @Test public void toolbarShouldBePresentAndVisible() {
    assertThat(toolbar, is(notNullValue()));
    assertThat(toolbar.getVisibility(), is(View.VISIBLE));
  }

  @Test public void toolbarShouldHaveProperTitle() {
  ...
  @Test public void progressBarShouldBeVisible() {
    assertThat(progressBar.getVisibility(), is(View.VISIBLE));
  }

  @Test public void shouldHideProgressWhenPresenterNotifiesSuccess() {
    presenter.onFetchJokesSuccess(MockModelsFactory.createListOfJokes(50));
    assertThat(progressBar.getVisibility(), is(View.GONE));
  }

  @Test public void shouldLoadJokesWhenPresenterNotifiesSuccess() {
    presenter.onFetchJokesSuccess(MockModelsFactory.createListOfJokes(50));
    assertThat(activity.getAdapter().getItemCount(), greaterThan(0));
  }

  @Test public void shouldHideProgressWhenPresenterNotifiesError() {
    presenter.onFetchJokesError(new Throwable("Error"));
    assertThat(progressBar.getVisibility(), is(View.GONE));
  }

  @Test public void shouldShowErrorToastWhenPresenterNotifiesError() {
    presenter.onFetchJokesError(new Throwable("Error"));
